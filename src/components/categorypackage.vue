<template>
    <main>
        <div v-for="goods in goodsinfo" class="product-list" v-if="(goods.product_info.category_id==='23')||(goods.product_info.category_id==='94')||(goods.product_info.category_id==='73')||(goods.product_info.category_id==='70')||goods.product_info.category_id==='56'||goods.product_info.category_id==='25'||goods.product_info.category_id==='26'">
