...
<template>
    <main>
        <div v-for="goods in goodsinfo" class="product-list" v-if="(goods.product_info.category_id==='80')||(goods.product_info.category_id==='83')||(goods.product_info.category_id==='84')">
